...
if __name__ == "__main__":
    ...
    glass2 = Glass(100, 200)  # TODO инициализировать ещё один стакан
    print(glass1.capacity_volume, glass1.occupied_volume)  # TODO распечатать атрибуты экземпляра glass2

    print("Доливаем воды в первый стакан...")
    #  TODO доливаем воды в первый стакан
    glass1.occupied_volume += 10
    print(glass1.capacity_volume, glass1.occupied_volume)
